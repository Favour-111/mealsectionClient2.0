...
const products = [
  { name: 'Rice', price: '1000.00', inStock: true },
  { name: 'Rice', price: '1000.00', inStock: false },
  { name: 'Rice', price: '1000.00', inStock: false },
  { name: 'Rice', price: '1000.00', inStock: true },
];
      ...
      <div className="max-w-md mx-auto bg-white shadow-lg">
        <header className="flex justify-between items-center p-4 border-b border-gray-200">
          ...
          <div className="flex items-center space-x-2">
            <img src="https://example.com/meal-section-logo.png" alt="MealSection Logo" className="h-10" />
          </div>
        ...
        <main>
          <div className="relative h-48 w-full overflow-hidden">
            <img src="https://example.com/elegance-banner.jpg" alt="Elegance" className="w-full h-full object-cover" />
            <h1 className="absolute bottom-4 left-4 text-white text-4xl font-bold">Elegance</h1>
          </div>

          <nav className="p-2 border-b border-gray-200 overflow-x-auto whitespace-nowrap">
            <ul className="flex justify-around">
              <li><a href="#" className="p-2 text-gray-500 font-medium">All</a></li>
              <li><a href="#" className="p-2 text-gray-500 font-medium">Proteins</a></li>
              <li className="relative"><a href="#" className="p-2 text-red-500 font-medium border-b-2 border-red-500">Carbohydrates</a></li>
              <li><a href="#" className="p-2 text-gray-500 font-medium">Drinks</a></li>
              <li><a href="#" className="p-2 text-gray-500 font-medium">Pastries</a></li>
              <li><a href="#" className="p-2 text-gray-500 font-medium">Pack</a></li>
            </ul>
          </nav>
